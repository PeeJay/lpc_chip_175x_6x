...
LPC_Status setupChannel(LPC_GPDMA_T *pGPDMA,
...
LPC_Status Chip_GPDMA_Interrupt(LPC_GPDMA_T *pGPDMA,
							uint8_t ChannelNum)
{
...
LPC_Status Chip_GPDMA_Transfer(LPC_GPDMA_T *pGPDMA,
						   uint8_t ChannelNum,
						   uint32_t src,
						   uint32_t dst,
						   GPDMA_FLOW_CONTROL_T TransferType,
...
LPC_Status Chip_GPDMA_PrepareDescriptor(LPC_GPDMA_T *pGPDMA,
...
LPC_Status Chip_GPDMA_SGTransfer(LPC_GPDMA_T *pGPDMA,
							 uint8_t ChannelNum,
