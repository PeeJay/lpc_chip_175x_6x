...
STATIC INLINE LPC_Status getReceiveFrameInfo(LPC_CAN_T *pCAN,
...
STATIC LPC_Status setupSTDSection(uint32_t *pCANAFRamAddr,
...
STATIC LPC_Status setupSTDRangeSection(uint32_t *pCANAFRamAddr,
...
STATIC LPC_Status setupEXTSection(uint32_t *pCANAFRamAddr, CAN_EXT_ID_ENTRY_T *pExtCANSec, uint16_t EntryNum)
{
	uint16_t i;
	uint32_t CurID = 0;
	uint32_t Entry;
...
STATIC LPC_Status setupEXTRangeSection(uint32_t *pCANAFRamAddr,
...
STATIC LPC_Status insertSTDEntry(LPC_CANAF_T *pCANAF,
...
/* Read STD Entry */
STATIC LPC_Status readSTDEntry(LPC_CANAF_T *pCANAF,
						   LPC_CANAF_RAM_T *pCANAFRam,
						   uint16_t Position,
						   bool   IsFullCANEntry,
						   CAN_STD_ID_ENTRY_T *pEntry)
...
LPC_Status removeSTDEntry(LPC_CANAF_T *pCANAF,
					  LPC_CANAF_RAM_T *pCANAFRam,
					  int16_t IDIndex,
					  bool IsFullCANEntry)
{
...
LPC_Status removeLUTEntry(LPC_CANAF_T *pCANAF,
					  LPC_CANAF_RAM_T *pCANAFRam,
...
/* Insert an entry into FullCAN Table */
LPC_Status Chip_CAN_InsertFullCANEntry(LPC_CANAF_T *pCANAF,
								   LPC_CANAF_RAM_T *pCANAFRam,
								   CAN_STD_ID_ENTRY_T *pEntry) {
...
LPC_Status Chip_CAN_InsertSTDEntry(LPC_CANAF_T *pCANAF,
							   LPC_CANAF_RAM_T *pCANAFRam,
							   CAN_STD_ID_ENTRY_T *pEntry)
{
...
LPC_Status Chip_CAN_InsertEXTEntry(LPC_CANAF_T *pCANAF,
							   LPC_CANAF_RAM_T *pCANAFRam,
...
LPC_Status Chip_CAN_InsertGroupSTDEntry(LPC_CANAF_T *pCANAF,
									LPC_CANAF_RAM_T *pCANAFRam,
...
LPC_Status Chip_CAN_InsertGroupEXTEntry(LPC_CANAF_T *pCANAF,
									LPC_CANAF_RAM_T *pCANAFRam,
...
LPC_Status Chip_CAN_RemoveFullCANEntry(LPC_CANAF_T *pCANAF,
								   LPC_CANAF_RAM_T *pCANAFRam,
								   int16_t Position) {
...
LPC_Status Chip_CAN_RemoveSTDEntry(LPC_CANAF_T *pCANAF,
							   LPC_CANAF_RAM_T *pCANAFRam,
							   int16_t Position)
{
...
LPC_Status Chip_CAN_RemoveGroupSTDEntry(LPC_CANAF_T *pCANAF,
									LPC_CANAF_RAM_T *pCANAFRam,
									int16_t Position)
{
...
LPC_Status Chip_CAN_RemoveEXTEntry(LPC_CANAF_T *pCANAF,
							   LPC_CANAF_RAM_T *pCANAFRam,
							   int16_t Position) {
...
LPC_Status Chip_CAN_RemoveGroupEXTEntry(LPC_CANAF_T *pCANAF,
									LPC_CANAF_RAM_T *pCANAFRam,
									int16_t Position)
{
...
LPC_Status Chip_CAN_ReadFullCANEntry(LPC_CANAF_T *pCANAF,
								 LPC_CANAF_RAM_T *pCANAFRam,
								 uint16_t Position,
								 CAN_STD_ID_ENTRY_T *pEntry)
{
...
LPC_Status Chip_CAN_ReadSTDEntry(LPC_CANAF_T *pCANAF,
							 LPC_CANAF_RAM_T *pCANAFRam,
							 uint16_t Position,
							 CAN_STD_ID_ENTRY_T *pEntry)
{
...
LPC_Status Chip_CAN_ReadGroupSTDEntry(LPC_CANAF_T *pCANAF,
								  LPC_CANAF_RAM_T *pCANAFRam,
								  uint16_t Position,
								  CAN_STD_ID_RANGE_ENTRY_T *pEntry)
{
...
LPC_Status Chip_CAN_ReadEXTEntry(LPC_CANAF_T *pCANAF,
							 LPC_CANAF_RAM_T *pCANAFRam,
							 uint16_t Position,
							 CAN_EXT_ID_ENTRY_T *pEntry)
{
...
LPC_Status Chip_CAN_ReadGroupEXTEntry(LPC_CANAF_T *pCANAF,
								  LPC_CANAF_RAM_T *pCANAFRam,
								  uint16_t Position,
								  CAN_EXT_ID_RANGE_ENTRY_T *pEntry)
...
LPC_Status Chip_CAN_FullCANReceive(LPC_CANAF_T *pCANAF, LPC_CANAF_RAM_T *pCANAFRam
