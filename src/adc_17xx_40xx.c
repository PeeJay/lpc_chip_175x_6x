...
/* Get the ADC value */
LPC_Status Chip_ADC_ReadValue(LPC_ADC_T *pADC, uint8_t channel, uint16_t *data)
{
...
LPC_Status Chip_ADC_ReadByte(LPC_ADC_T *pADC, ADC_CHANNEL_T channel, uint8_t *data)
{
	uint16_t temp;
	LPC_Status rt;
