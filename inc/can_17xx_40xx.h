 ...
 */
LPC_Status Chip_CAN_SetAFLUT(LPC_CANAF_T *pCANAF, LPC_CANAF_RAM_T *pCANAFRam, CANAF_LUT_T *pAFSections);
 ...
 * @return	SUCCESS/ERROR
 */
LPC_Status Chip_CAN_InsertFullCANEntry(LPC_CANAF_T *pCANAF, LPC_CANAF_RAM_T *pCANAFRam, CAN_STD_ID_ENTRY_T *pEntry);
 ...
 * @return	SUCCESS/ERROR
 */
LPC_Status Chip_CAN_InsertSTDEntry(LPC_CANAF_T *pCANAF, LPC_CANAF_RAM_T *pCANAFRam, CAN_STD_ID_ENTRY_T *pEntry);
 ...
 * @return	SUCCESS/ERROR
 */
LPC_Status Chip_CAN_InsertGroupSTDEntry(LPC_CANAF_T *pCANAF, LPC_CANAF_RAM_T *pCANAFRam, CAN_STD_ID_RANGE_ENTRY_T *pEntry);
 ...
 * @return	SUCCESS/ERROR
 */
LPC_Status Chip_CAN_InsertEXTEntry(LPC_CANAF_T *pCANAF, LPC_CANAF_RAM_T *pCANAFRam, CAN_EXT_ID_ENTRY_T *pEntry);
 ...
 * @return	SUCCESS/ERROR
 */
LPC_Status Chip_CAN_InsertGroupEXTEntry(LPC_CANAF_T *pCANAF, LPC_CANAF_RAM_T *pCANAFRam, CAN_EXT_ID_RANGE_ENTRY_T *pEntry);
 ...
 * @return	SUCCESS/ERROR
 */
LPC_Status Chip_CAN_RemoveFullCANEntry(LPC_CANAF_T *pCANAF, LPC_CANAF_RAM_T *pCANAFRam, int16_t Position);
 ...
 * @return	SUCCESS/ERROR
 */
LPC_Status Chip_CAN_RemoveSTDEntry(LPC_CANAF_T *pCANAF, LPC_CANAF_RAM_T *pCANAFRam, int16_t Position);
 ...
 * @return	SUCCESS/ERROR
 */
LPC_Status Chip_CAN_RemoveGroupSTDEntry(LPC_CANAF_T *pCANAF, LPC_CANAF_RAM_T *pCANAFRam, int16_t Position);
 ...
 * @return	SUCCESS/ERROR
 */
LPC_Status Chip_CAN_RemoveEXTEntry(LPC_CANAF_T *pCANAF, LPC_CANAF_RAM_T *pCANAFRam, int16_t Position);
 ...
 * @return	SUCCESS/ERROR
 */
LPC_Status Chip_CAN_RemoveGroupEXTEntry(LPC_CANAF_T *pCANAF, LPC_CANAF_RAM_T *pCANAFRam, int16_t Position);
 ...
 * @return	SUCCESS/ERROR
 */
LPC_Status Chip_CAN_ReadFullCANEntry(LPC_CANAF_T *pCANAF, LPC_CANAF_RAM_T *pCANAFRam, uint16_t Position,
 ...
 * @return	SUCCESS/ERROR
 */
LPC_Status Chip_CAN_ReadSTDEntry(LPC_CANAF_T *pCANAF, LPC_CANAF_RAM_T *pCANAFRam, uint16_t Position,
							 CAN_STD_ID_ENTRY_T *pEntry);
 ...
 * @return	SUCCESS/ERROR
 */
LPC_Status Chip_CAN_ReadGroupSTDEntry(LPC_CANAF_T *pCANAF, LPC_CANAF_RAM_T *pCANAFRam, uint16_t Position,
 ...
 * @return	SUCCESS/ERROR
 */
LPC_Status Chip_CAN_ReadEXTEntry(LPC_CANAF_T *pCANAF, LPC_CANAF_RAM_T *pCANAFRam, uint16_t Position,
 ...
 * @return	SUCCESS/ERROR
 */
LPC_Status Chip_CAN_ReadGroupEXTEntry(LPC_CANAF_T *pCANAF, LPC_CANAF_RAM_T *pCANAFRam, uint16_t Position,
 ...
 * @return	SUCCESS/ERROR
 */
LPC_Status Chip_CAN_SetBitRate(LPC_CAN_T *pCAN, uint32_t BitRate);
 ...
 */
LPC_Status Chip_CAN_Send(LPC_CAN_T *pCAN, CAN_BUFFER_ID_T TxBufID, CAN_MSG_T *pMsg);
 ...
 * @return	SUCCESS (message information saved) or ERROR (no message received)
 */
LPC_Status Chip_CAN_Receive(LPC_CAN_T *pCAN, CAN_MSG_T *pMsg);
 ...
 * @return	SUCCESS (message information saved) or ERROR (no message received)
 */
LPC_Status Chip_CAN_FullCANReceive(LPC_CANAF_T *pCANAF,
